...
| [design.md](design.md) | Product principles and component patterns aligned to the broadcast-machine identity in `BRAINDUMP.md` |
...
| File | Purpose |
|------|---------|
| [../BRAINDUMP.md](../BRAINDUMP.md) | Customer-voice product brief (broadcast machine / spatial cohesion phase) |
| [../.aidlc/issues/](../.aidlc/issues/) | Granular tracked issues that drive each AIDLC run |
...
| [audits/security-report.md](audits/security-report.md) | Security audit (proxy, CSP, public-URL hardening) |
