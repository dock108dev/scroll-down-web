...
export function ParlaySheet({
  ...
  return (
    <div data-testid="parlay-sheet" className="fixed inset-0 z-50 flex items-end justify-center md:items-center">
              ...
              return (
                ...
                >
                  <div className="flex-1 min-w-0 space-y-1">
                    ...
                    {staleBetIds.has(id) && (
                      <div
                        className="flex items-center gap-1.5 rounded-lg px-2 py-1 text-[10px] mt-1"
                        style={{
                          backgroundColor: "rgba(234, 179, 8, 0.08)",
                          border: "1px solid rgba(234, 179, 8, 0.20)",
                          color: "rgb(234, 179, 8)",
                      ...
                      >
                        ...
                        Price may have changed — confirm with current odds
                      </div>
                    )}
                  </div>
                  <button
