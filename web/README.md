...
Next.js frontend for Scroll Down Sports. Displays live game scores, play-by-play timelines, betting odds analysis (FairBet), and an MLB lineup simulator. Connects to a backend API for all data; this repo contains no database or scraping logic.
...
| `/analytics/mlb` | MLB Monte Carlo lineup simulator | Auth required |
